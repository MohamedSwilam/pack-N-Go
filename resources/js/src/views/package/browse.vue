<template>
    <div class="vx-col w-full mb-base" v-if="can('browse-employee')">
        <vx-card ref="browse" title="Packages List" collapse-action refreshContentAction @refresh="getPackages">
            <vs-table search :data="packages">
                <template slot="header">
                    <vs-button v-if="can('browse-employee')" to="/dashboard/package/create" size="small" icon-pack="feather" icon="icon-plus">Create Package</vs-button>
                </template>
                <template slot="thead">
                    <vs-th>#</vs-th>
                    <vs-th>Name</vs-th>
