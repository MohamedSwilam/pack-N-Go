...
@section('content')
    ...
    <div class="intro-area pd-top-108">
        <div class="container">
            <div class="section-title text-lg-center text-left">
                <h2 class="title"><span>We Are</span> Travel Point</h2>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-2">
                    <div class="thumb about-section-right-thumb">
                        <img src="/images/website/others/9.png" alt="img">
                        <img class="about-absolute-thumb" src="/images/website/others/10.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="/images/website/destination-list/17.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="/images/website/icons/13.png" alt="img"> 550+ Tour Complite</li>
                                <li><img src="/images/website/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="/images/website/destination-list/18.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="/images/website/icons/13.png" alt="img"> 120+ Tour Complite</li>
                                <li><img src="/images/website/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="/images/website/destination-list/19.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="/images/website/icons/13.png" alt="img"> 130+ Tour Complite</li>
                                <li><img src="/images/website/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
    ...
    <div class="team-newslater-bg" style="background-image:url(/images/website/bg/4.png);">
        <!-- team area end -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="/images/website/team/1.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="/images/website/team/2.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="/images/website/team/3.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="/images/website/team/4.png" alt="team">
                            </div>
