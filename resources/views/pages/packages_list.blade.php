                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Dubai City</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Eiffel Tower</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Colosseum, Rome</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Bali Province</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Barcelona city beach</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        ...
                        <div class="details">
                            ...
                            <h4 class="title"><a href="{{route('package_details')}}">Hurawalhi Island</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
